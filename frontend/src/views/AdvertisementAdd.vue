<template>
    <div class="login-form">
        <form @submit.prevent="create" method="post">
            ...
            <h4 class="modal-title">Dodaj ogłoszenie</h4>
            ...
            <input type="submit" class="btn btn-primary btn-block btn-lg" value="Dodaj">
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            create(){
                ...
                this.$store.dispatch('createAdvertisement', postData)
